...
$(document).ready(function() {
    ...
    $('.sb').click(function(event){
        ...
        // create smoothbox
       $('body').append('<div class="smoothbox sb-load"><div class="smoothbox-table"><div class="smoothbox-centering"><div class="smoothbox-sizing"><div class="sb-nav"><a href="#" class="sb-cancel" alt="Close"><i class="icon-remove"></i></a></div><ul class="sb-items"></ul></div></div></div></div>');
    ...
    $(document).on('click', ".sb-cancel, .smoothbox", function(event){
    ...
    $(document).on('click', ".sb-items", function(event){
    ...
    //     if(/MSIE (\d+)\.\d+;/.test(navigator.userAgent) && RegExp.$1 < 9) {
